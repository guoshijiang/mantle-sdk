...
export const l2Networks: L2Networks = {
  ...
  421611: {
    chainID: 421611,
    name: 'ArbRinkeby',
    explorerUrl: 'https://testnet.mantlescan.io',
    partnerChainID: 4,
    isMantle: true,
  ...
  421613: {
    ...
    explorerUrl: 'https://goerli-rollup-explorer.mantle.io',
    isMantle: true,
    isCustom: false,
    name: 'Mantle Rollup Goerli Testnet',
    partnerChainID: 5,
    tokenBridge: {
  ...
  42170: {
    ...
    explorerUrl: 'https://nova-explorer.mantle.io',
    isMantle: true,
    isCustom: false,
    name: 'Mantle Nova',
    partnerChainID: 1,
