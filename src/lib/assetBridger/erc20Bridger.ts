...
import { L2ArbitrumGateway__factory as L2MantleGateway__factory } from '../abi/factories/L2ArbitrumGateway__factory'
...
export class AdminErc20Bridger extends Erc20Bridger {
  /**
   * Register a custom token on the Mantle bridge
   * See https://developer.mantlenetworkio.com/docs/bridging_assets#the-mantle-generic-custom-gateway for more details
   * @param l1TokenAddress Address of the already deployed l1 token. Must inherit from https://developer.mantlenetworkio.com/docs/sol_contract_docs/md_docs/arb-bridge-peripherals/tokenbridge/ethereum/icustomtoken.
   * @param l2TokenAddress Address of the already deployed l2 token. Must inherit from https://developer.mantlenetworkio.com/docs/sol_contract_docs/md_docs/arb-bridge-peripherals/tokenbridge/mantle/iarbtoken.
   * @param l1Signer The signer with the rights to call registerTokenOnL2 on the l1 token
   * @param l2Provider Mantle rpc provider
   * @returns
   */
