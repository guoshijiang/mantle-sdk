...
/**
 * Mantle specific formats
 */
export class MantleProvider extends Web3Provider {
  private static arbFormatter = new ArbFormatter()

  /**
   * Mantle specific formats
   * @param provider Must be connected to an Mantle network
   * @param network Must be an Mantle network
   */
