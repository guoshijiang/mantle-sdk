...
import { RedeemScheduledEvent } from '../abi/MtRetryableTx'
...
export class L2TransactionReceipt implements TransactionReceipt {
  ...
  public getL2ToL1Events(): L2ToL1TransactionEvent[] {
    ...
    const mantleLogs = parseTypedLogs(MtSys__factory, this.logs, 'L2ToL1Tx')
    return [...classicLogs, ...mantleLogs]
  }
  ...
  public getRedeemScheduledEvents(): EventArgs<RedeemScheduledEvent>[] {
    return parseTypedLogs(MtRetryableTx__factory, this.logs, 'RedeemScheduled')
  }
  ...
  public async getBatchNumber(l2Provider: providers.JsonRpcProvider) {
    ...
    const arbProvider = new MantleProvider(l2Provider)
